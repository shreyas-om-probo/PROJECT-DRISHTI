...
# Set up the logger
logger = setup_logger(logger_name='contract_processor', log_file='contract_processing.log')
...
def event_generate_v1(user_prompt: TextInput):
    ...
    print(combined)
    print("------------------------------------------------------------------------------------------------------------------")
    combined[0] = extract_json_for_against(combined[0])
    print(combined)
    print("------------------------------------------------------------------------------------------------------------------")
    return {"overview":overview[0],"arguments":combined[0],"overview_references":overview[1],'arguments_references':combined[1]}
